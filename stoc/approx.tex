...
\BAL \mincut_{G_v}(u,v)&\le w(\pt_{G_v}(S^i_v\cap S))\\&=w(\pt_G(S^i_v\cap S)) \\&\le w(\pt_GS)+\e\la \\&\le \mincut_G(u,v) + \e\,\mincut_G(u,v) ,\EAL
as promised.
\EP
...
\BAL |P_{\text{ordered}}(G,U,W)\sm P_{\text{ordered}}(G_\lar,U_\lar,W)| &\ge \f{|U|}2|D^i| \\&\ge\Om\lp\f{|D|}{\log|U|}\rp   .\EAL
Taking expectations and applying (d), 
\BAL \E[|P_{\text{ordered}}(G,U,W)\sm P_{\text{ordered}}(G_\lar,U_\lar,W)|] &\ge\Om\lp\f{\E[|D|]}{\log|U|}\rp    \\&\ge \Om\lp\f{|U|\cd|D^*|}{\log^2|U|}\rp  .\EAL
Moreover,
...
\BAL &\E[|P_{\text{ordered}}(G,U,W)\sm P_{\text{ordered}}(G_\lar,U_\lar,W)|] \\&\ge \Om\lp\f{|P_{\text{ordered}}(G,U,W)|}{\log|R|}\rp   .\EAL
