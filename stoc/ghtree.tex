...
\newcommand{\ct}{{\sc CT}\xspace}
               ...
               \titlenote{JL's research is supported in part by NSF awards CCF-1907820, CCF-1955785, and CCF-2006953. DP's research is supported in part by NSF awards CCF-1750140 and CCF-1955703.}
...
%%% The following is specific to STOC '21 and the paper
%%% 'Approximate Gomory-Hu Tree Is Faster Than $n-1$ Max-flows'
%%% by Jason Li and Debmalya Panigrahi.
%%%
%\setcopyright{rightsretained}
\acmPrice{}
\acmDOI{10.1145/3406325.3451112}
\acmYear{2021}
\copyrightyear{2021}
\acmSubmissionID{stoc21main-p417-p}
\acmISBN{978-1-4503-8053-9/21/06}
\acmConference[STOC '21]{Proceedings of the 53rd Annual ACM SIGACT Symposium on Theory of Computing}{June 21--25, 2021}{Virtual, Italy}
\acmBooktitle{Proceedings of the 53rd Annual ACM SIGACT Symposium on Theory of Computing (STOC '21), June 21--25, 2021, Virtual, Italy}
...
\keywords{graph algorithm, Gomory-Hu tree, graph connectivity}
